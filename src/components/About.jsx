        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              of experience building and supporting enterprise web applications,
            ...
            >
              Experienced across{" "}
              <span className="font-semibold text-[#10B981]">
                REST APIs, microservices, Spring MVC, Spring Data JPA/Hibernate,
                Spring Security
              </span>
              , relational and NoSQL databases — with hands-on{" "}
              <span className="font-semibold text-[#10B981]">React.js</span>{" "}
            ...
            <motion.p
              ...
              className="mt-4 text-[#1A1D23]/80 dark:text-[#E7E9EC]/80 leading-relaxed text-lg"
            >
              Comfortable across the SDLC — from unit testing, CI/CD and code
              reviews to{" "}
              <span className="font-semibold text-[#1A1D23] dark:text-white">
                production support and Agile delivery
              </span>
              . Also experienced with{" "}
              <span className="font-semibold text-[#10B981]">
                Node.js/Express.js and MongoDB
              </span>{" "}
              for supporting services and integrations.
            </motion.p>
          </motion.div>
        </div>
      </div>
