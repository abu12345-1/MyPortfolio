...
const projects = [
  {
    ...
    desc: "Built Spring Boot microservices for customer, product, order, payment and inventory modules, each independently maintainable. Designed and consumed REST APIs connecting React.js screens, backend services and external integrations. Implemented Spring Security for auth, MongoDB collections with indexing/query optimization, and selected Node.js/Express.js supporting services. Drove CI/CD with Maven, Git and Jenkins across dev and test environments.",
    tags: [
      "Java",
      "Spring Boot",
      "Microservices",
  ...
  {
    title: "Banking & Financial Services Application",
    subtitle: "Banking / Financial Services",
    file: "banking-finserv",
    desc: "Developed and maintained a financial services application for customer information, accounts, transactions and service requests. Built Spring Boot REST APIs and React.js UIs, with service and persistence layers using Spring MVC, Spring Data JPA and Hibernate. Implemented centralized exception handling, request validation and consistent API error responses. Improved performance through SQL/query tuning and secure RBAC patterns for sensitive financial workflows.",
    tags: [
      "Java",
      "Spring Boot",
      "Spring MVC",
